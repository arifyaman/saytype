...
cargo test                   # unit tests (transcript, injector, audio format conversion, VAD AudioRing, ASR model detection + polish + backend fallback, daemon stable-target logic + toggle debounce, config)
